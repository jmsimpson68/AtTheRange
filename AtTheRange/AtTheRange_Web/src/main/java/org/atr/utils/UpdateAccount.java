...
import org.atr.NotifierServiceBean;
...
public class UpdateAccount extends HttpServlet {
	...
	@Resource(name="java:module/NotifierServiceBean")
	NotifierServiceBean notifierService;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			notifierService.notifiy((String) rso.get("email"), "Account information changed for RSO OnDuty!", buf.toString());
